---
created: 2026-03-25 13:24
reviewed: 2026-03-25 13:24
tags:
  - math/subject/diffeq
---
...
> Our goal is to break up $g$ into multiple functions that are of the same type or "nature".
...
In other words, we multiply $x$ of the $r$-th power to $e^{ x }$, making $y_{p}$ linearly independent from fundamental functions found in $y_{c}$.
